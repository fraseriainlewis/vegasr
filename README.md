...
[vegas+](https://arxiv.org/abs/2009.05112) algorithm (2021) is a more
efficient mversion of the original (1978) and widely used vegas
...
pass objects back and forth to Python vegas and so Python (\>=3.10) must
be available. There is a separate install script which deals with the
necessary Python dependencies. The vegasr GitHub repository is
