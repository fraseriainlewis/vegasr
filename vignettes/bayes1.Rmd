...
### Quickstart
A first example of how to compute a Bayesian posterior density using vegasr with the integrand written as an R function. Examples of how to use vegasr to computer general integrals can be found in the help pages.

## Model Formulation

The model implemented here is a non-centered parameterization (helps improve MCMC sampling, e.g if using Stan) for a logistic model.
