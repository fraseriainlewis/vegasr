...
r_compute_log_lik<-function(theta,      # matrix Batch x M
  ...
  if(uselog[1]==1.){ # search phase for max - keep in log
...
```{r logpos2,include=FALSE,eval=FALSE}
set.seed(99999)
...
result<-vegas(f=r_compute_log_lik,
                        ...
                        extra_args=list(
                        y=y,treat=treat,shiftby=mymax,uselog=0.))
print(result)
