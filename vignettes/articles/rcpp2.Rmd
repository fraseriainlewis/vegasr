...
## Quickstart
This article is a more complex version of the vegasr vignette [Rcpp](https://fraseriainlewis.github.io/vegasr/articles/rcpp.html) where the hierarchical Bayesian model being estimated is a basket trial comprising of five baskets and binary response with logistic link function. This model has 14 parameters. 
...
# Fit model
nsamps <- 200000       # number of posterior samples (after removing burn-in) per chain
...
for(z in myz){
  f_z[i]<-vegasBayesPosterior(f=vegasr::eigen_fn_marg_2,
                            lower=lower[-1],
                            upper=upper[-1],
                            nitn_warm = 20, neval_warm = 500000,
                            nitn = 10, neval = 50000,
                            errTol=0.1,maxIter=25,seed=99999,nsearch=10000,
                            log_evidence = result_logEv,
                            extra_args=list(
                              y=thedata$y,
                              treat=thedata$treat,
