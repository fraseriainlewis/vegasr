...
#'
#' @export
vegasip <- function(f, lower,upper, nitn_warm = 10, neval_warm = 1000,
                                            nitn = 10, neval = 1000, errTol=1,maxIter=5,
                                            seed = 99999,adapt=FALSE, extra_args = list()) {
...
# compute x values and each of the x value weight (on p(x))
# and get grid
